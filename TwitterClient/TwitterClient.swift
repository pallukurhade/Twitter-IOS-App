...
class TwitterClient: BDBOAuth1SessionManager {
    static let sharedInstance = TwitterClient(baseURL: URL(string: "https://api.twitter.com")!, consumerKey: "JQFnQdko027blgr8ASYwDomk2", consumerSecret: 	"ow3guPbqhATyLOh1Wew6beQszOVCQLOxRvbC71IpHOnDzjj4WV")
